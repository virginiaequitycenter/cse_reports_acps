##############################################################
# ACPS Career Self-Efficacy Analysis- Walton Middle School            
...
#          graders at Walton Middle School in the Fall of 2024
##############################################################
...
# Asian students removed to comply with FERPA and protect student privacy

ggplot(data=career_walton, aes(y=total_score)) + 
  geom_point(data=career_walton %>% dplyr::filter(Ethnicity!="AS"),
...
ggsave("../plots/Walton_CSE_eth_2024.pdf")
...
ggplot() + 
  geom_point(data=career_walton, aes(y=total_score, x=-1), position=position_jitter(0.1), alpha=1, color="black") +
...
ggsave("../plots/Walton_CSE_studentgrp_2024.pdf")
