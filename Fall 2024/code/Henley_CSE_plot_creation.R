##############################################################
# ACPS Career Self-Efficacy Analysis- Henley Middle School            
...
#          graders at Henley Middle School in the Fall of 2024
##############################################################
...
ggsave("../plots/Henley_CSE_eth_2024.pdf")
...
ggplot() + 
  geom_point(data=career_henley, aes(y=total_score, x=-1), position=position_jitter(0.1), alpha=1, color="black") +
...
ggsave("../plots/Henley_CSE_studentgrp_2024.pdf")