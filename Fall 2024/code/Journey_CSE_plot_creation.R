##############################################################
# ACPS Career Self-Efficacy Analysis- Journey Middle School            
...
#          graders at Journey Middle School in the Fall of 2024
##############################################################
...
ggsave("../plots/Journey_CSE_eth_2024.pdf")
...
ggplot() + 
  geom_point(data=career_journey, aes(y=total_score, x=-1), position=position_jitter(0.1), alpha=1, color="black") +
...
ggsave("../plots/Journey_CSE_studentgrp_2024.pdf")
