...
career_burley_eth <- subset(career_burley, career_burley$Ethnicity!="AI" )

mean_Eth <- career_burley_eth %>% group_by(Ethnicity) %>% summarise(mean_score=mean(total_score, na.rm=TRUE),
                                                                 obs=n())
...
ggplot(data=career_burley_eth, aes(y=total_score)) + 
  geom_point(data=career_burley_eth %>% dplyr::filter(Ethnicity!="AS"),
    aes(x=0, color=Ethnicity), position=position_jitter(0.1), alpha=.7) +
  geom_hline(data= mean_Eth %>% dplyr::filter(Ethnicity!="AS"), aes(yintercept = mean_score,col=Ethnicity), linewidth=1) +
  ...
  scale_color_manual(values=c("#D9470C", "#0C9ED9", "#139E02", "#F8BE3D"))+
...
ggsave("../plots/Burley Middle School Career Self Efficacy Scores by Ethnicity.pdf")
...
ggplot() + 
  geom_point(data=career_burley, aes(y=total_score, x=-1), position=position_jitter(0.1), alpha=.7, color="black") +
  ...
  geom_point(data=career_gg1, aes(y=total_score, x=3), position=position_jitter(0.1), alpha=.7, color="#139E02") +
  geom_point(data=career_sped, aes(y=total_score, x=4), position=position_jitter(0.1), alpha=.7, color="#F8BE3D") +
  scale_y_continuous(limits=c(50,105), minor_breaks=seq(50,105,5), breaks=seq(50,100,10)) +
  ...
  geom_segment(data= mean_gg1, aes(y=mean_score, yend=mean_score, x=2.75, xend=3.25), linewidth=1, color ="#139E02") +
  geom_segment(data= mean_sped, aes(y=mean_score, yend=mean_score, x=3.75, xend=4.25), linewidth=1, color ="#F8BE3D") +
  geom_hline(yintercept=80,linetype="dashed")+
  theme_minimal()+
  theme(axis.text.x=element_blank(),
        panel.grid.major.x = element_blank(),
...
ggsave("../plots/Burley Middle School Career Self Efficacy Scores by Student Group.pdf")

##############################################################
# Burley Self-Efficacy Subscores- by Ethnicity                          
##############################################################
...
mean_burley <- career_burley %>% summarise(mean_score=mean(SE_subscore, na.rm=TRUE),
                                             obs=n())

mean_Eth <- career_burley_eth %>% group_by(Ethnicity) %>% summarise(mean_score=mean(SE_subscore, na.rm=TRUE),
                                                                 obs=n())
eth.labs <- c("Asian Students", "Black Students", "Hispanic Students", "Multiracial Students", "White Students")
names(eth.labs) <- c("AS", "BL", "HL", "MR", "WH")

# Plot Creation
#### Plots Burley's self efficacy subscores by ethnicity with mean value and individual scores

ggplot(data=career_burley_eth, aes(y=SE_subscore)) + 
  geom_point(data= career_burley_eth %>% dplyr::filter(Ethnicity!="AS"),
    aes(x=0, color=Ethnicity), position=position_jitter(0.1), alpha=.7) +
  geom_hline(data= mean_Eth %>% dplyr::filter(Ethnicity!="AS"), aes(yintercept = mean_score,col=Ethnicity), linewidth=1) +
  labs(x="Ethnicity", y="Self-Efficacy Subscore", 
       title="Burley Middle School Self Efficacy Subscores by Ethnicity")+
...
ggsave("../plots/Burley Middle School SE Subscores by Ethnicity.pdf")

##############################################################
# Burley Self-Efficacy Subscores- by Student Group                        
##############################################################
...
# Plot Creation
#### Plot of Burley's  Self Efficacy subscores for student groups of interest 

ggplot() + 
  geom_point(data=career_burley, aes(y=SE_subscore, x=-1), position=position_jitter(0.1), alpha=.7, color="black") +
  geom_point(data=career_shp, aes(y=SE_subscore, x=0), position=position_jitter(0.1), alpha=.7, color="#8D029E") +
  geom_point(data=career_avid, aes(y=SE_subscore, x=1), position=position_jitter(0.1), alpha=.7, color="#D9470C") +
  geom_point(data=career_el, aes(y=SE_subscore, x=2), position=position_jitter(0.1), alpha=.7, color="#0C9ED9") +
  geom_point(data=career_gg1, aes(y=SE_subscore, x=3), position=position_jitter(0.1), alpha=.7, color="#139E02") +
  geom_point(data=career_sped, aes(y=SE_subscore, x=4), position=position_jitter(0.1), alpha=.7, color="#F8BE3D") +
  scale_y_continuous(limits=c(0,55), minor_breaks=seq(0,55,5), breaks=seq(0,50,10)) +
  geom_segment(data= mean_burley, aes(y=mean_score, yend=mean_score, x=-1.25, xend=-.75), linewidth=1, color ="black") +
  geom_segment(data= mean_shp, aes(y=mean_score, yend=mean_score, x=-.25, xend=.25), linewidth=1, color ="#8D029E") +
  geom_segment(data= mean_avid, aes(y=mean_score, yend=mean_score, x=.75, xend=1.25), linewidth=1, color ="#D9470C") +
  ...
  labs(x="Student Group", y="Self-Efficacy Subscore", 
       title="Burley Middle School Self Efficacy Subscores by Student Group")

ggsave("../plots/Burley Middle School SE Subscores by Student Group.pdf")

##############################################################
# Burley Outcome Expectancy Subscores- by Ethnicity                        
##############################################################
...
mean_burley <- career_burley %>% summarise(mean_score=mean(OE_subscore, na.rm=TRUE),
                                             obs=n())

mean_Eth <- career_burley_eth %>% group_by(Ethnicity) %>% summarise(mean_score=mean(OE_subscore, na.rm=TRUE),
                                                                 obs=n())
eth.labs <- c("Asian Students", "Black Students", "Hispanic Students", "Multiracial Students", "White Students")
names(eth.labs) <- c("AS", "BL", "HL", "MR", "WH")
...
ggplot(data=career_burley_eth, aes(y=OE_subscore)) + 
  geom_point(data=career_burley_eth %>% dplyr::filter(Ethnicity!="AS"),
    aes(x=0, color=Ethnicity), position=position_jitter(0.1), alpha=.7) +
  geom_hline(data= mean_Eth %>% dplyr::filter(Ethnicity!="AS"), aes(yintercept = mean_score,col=Ethnicity), linewidth=1) +
  labs(x="Ethnicity", y="Outcome Expectancy Subscore", 
       title="Burley Middle School Outcome Expectancy Subscores by Ethnicity")+
...
ggsave("../plots/Burley Middle School OE Subscores by Ethnicity.pdf")

##############################################################
# Burley Outcome Expectancy Subscores- by Student Group                        
##############################################################
...
# Plot Creation
#### Plot of Burley's Outcome Expectancy subscores for student groups of interest 

ggplot() + 
  geom_point(data=career_burley, aes(y=OE_subscore, x=-1), position=position_jitter(0.1), alpha=.7, color="black") +
  geom_point(data=career_shp, aes(y=OE_subscore, x=0), position=position_jitter(0.1), alpha=.7, color="#8D029E") +
  geom_point(data=career_avid, aes(y=OE_subscore, x=1), position=position_jitter(0.1), alpha=.7, color="#D9470C") +
  geom_point(data=career_el, aes(y=OE_subscore, x=2), position=position_jitter(0.1), alpha=.7, color="#0C9ED9") +
  geom_point(data=career_gg1, aes(y=OE_subscore, x=3), position=position_jitter(0.1), alpha=.7, color="#139E02") +
  geom_point(data=career_sped, aes(y=OE_subscore, x=4), position=position_jitter(0.1), alpha=.7, color="#F8BE3D") +
  scale_y_continuous(limits=c(0,50), minor_breaks=seq(0,50,5), breaks=seq(0,50,10)) +
  geom_segment(data= mean_burley, aes(y=mean_score, yend=mean_score, x=-1.25, xend=-.75), linewidth=1, color ="black") +
  geom_segment(data= mean_shp, aes(y=mean_score, yend=mean_score, x=-.25, xend=.25), linewidth=1, color ="#8D029E") +
  geom_segment(data= mean_shp, aes(y=mean_score, yend=mean_score, x=.75, xend=1.25), linewidth=1, color ="#D9470C") +
  geom_segment(data= mean_el, aes(y=mean_score, yend=mean_score, x=1.75, xend=2.25), linewidth=1, color ="#0C9ED9") +
  geom_segment(data= mean_gg1, aes(y=mean_score, yend=mean_score, x=2.75, xend=3.25), linewidth=1, color ="#139E02") +
  geom_segment(data= mean_sped, aes(y=mean_score, yend=mean_score, x=3.75, xend=4.25), linewidth=1, color ="#F8BE3D") +
  geom_hline(yintercept=38,linetype="dashed")+
  ...
  labs(x="Student Group", y="Outcome Expectancy Subscore", 
       title="Burley Middle School Outcome Expectancy Subscores by Student Group")

ggsave("../plots/Burley Middle School OE Subscores by Student Group.pdf")
